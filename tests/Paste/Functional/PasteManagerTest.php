...
namespace Alcohol\Paste\Tests\Functional;

use Alcohol\Paste\Entity\Paste;
use Alcohol\Paste\Entity\PasteManager;
use Alcohol\Paste\Util\HashUtils;
...
class PasteManagerTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedException \Alcohol\Paste\Exception\StorageException
     */
    public function testCreateThrowsStorageException()
    {
         ...
         * @var \Alcohol\Paste\Util\HashUtils $hash
         */
    ...
    public function testCreate()
    {
        ...
        $this->assertInstanceOf('Alcohol\Paste\Entity\Paste', $manager->create('body'));
    }
    ...
    public function testCreateCustomTtl()
    {
        ...
        $this->assertInstanceOf('Alcohol\Paste\Entity\Paste', $manager->create('body', 120));
    }

    /**
     * @testdox Calling update() throws a TokenException if the token is not valid.
     * @expectedException \Alcohol\Paste\Exception\TokenException
     */
    ...
    {
        return $this
            ->getMockBuilder('Alcohol\Paste\Util\HashUtils')
